...
always @(posedge clk)
begin
    data_out[31*(PNUM*DW)+3*DW+:DW]<=data_in[31*(PNUM*DW)+3*DW+:DW];             
    data_out[31*(PNUM*DW)+2*DW+:DW]<=data_in[31*(PNUM*DW)+2*DW+:DW];   
    data_out[31*(PNUM*DW)+1*DW+:DW]<=data_in[31*(PNUM*DW)+1*DW+:DW];   
    data_out[31*(PNUM*DW)+0*DW+:DW]<=data_in[31*(PNUM*DW)+0*DW+:DW];
    data_out_vld[31*PNUM+3+:1]<=data_in_vld[31*PNUM+3+:1];
    data_out_vld[31*PNUM+2+:1]<=data_in_vld[31*PNUM+2+:1];
    data_out_vld[31*PNUM+1+:1]<=data_in_vld[31*PNUM+1+:1];
    data_out_vld[31*PNUM+0+:1]<=data_in_vld[31*PNUM+0+:1];
end
...
if(data_in_meg[i+1])
begin
    data_out[i*(PNUM*DW)+3*DW+:DW]<=0;             
    data_out[i*(PNUM*DW)+2*DW+:DW]<=data_in[i*(PNUM*DW)+3*DW+:DW];   
    data_out[i*(PNUM*DW)+1*DW+:DW]<=data_in[i*(PNUM*DW)+2*DW+:DW];   
    data_out[i*(PNUM*DW)+0*DW+:DW]<=data_in[i*(PNUM*DW)+1*DW+:DW];
    data_out_vld[i*PNUM+3+:1]<=0;
    data_out_vld[i*PNUM+2+:1]<=data_in_vld[i*PNUM+3+:1];
    data_out_vld[i*PNUM+1+:1]<=data_in_vld[i*PNUM+2+:1];
    data_out_vld[i*PNUM+0+:1]<=data_in_vld[i*PNUM+1+:1];
end else begin
    ...
    data_out_vld[i*PNUM+3+:1]<=data_in_vld[i*PNUM+3+:1];
    data_out_vld[i*PNUM+2+:1]<=data_in_vld[i*PNUM+2+:1];
    data_out_vld[i*PNUM+1+:1]<=data_in_vld[i*PNUM+1+:1];
    data_out_vld[i*PNUM+0+:1]<=data_in_vld[i*PNUM+0+:1];
end
